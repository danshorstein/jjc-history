...
EVENTS = [
    ...
    (1901, "Hebrew Orthodox Congregation B'nai Israel incorporated",
     "Five Orthodox families, grown to about forty people, incorporate B'nai Israel on December 6, 1901. Max Frank serves as first president; Rev. Benjamin Safer of Pušalotas, Lithuania arrives as spiritual leader — and the city's first kosher butcher and mohel. Many founding families (Finkelsteins, Schemers, Slotts) came from the same Lithuanian town.",
     "both", [{"vid": "00077", "seq": 24}], ["isjl", "wikipedia"]),
    (1907, "A synagogue in LaVilla",
     "B'nai Israel erects its first synagogue at Jefferson and Duval Streets in the LaVilla neighborhood, heart of the immigrant community. (Sources differ: Wikipedia says 1907, ISJL says by 1909 — see Mysteries.)",
     "research", [], ["wikipedia", "isjl"]),
    ...
    (1927, "The first Year Book",
     "'In this first attempt to produce a Year Book for the Jacksonville Jewish Center…' — the 1926-27 (5687) volume opens a tradition that will continue for over ninety years.",
     "yearbook", [{"vid": "00002", "seq": 5}, {"vid": "00002", "seq": 24}], []),
    ...
    (1938, "Ten years in the building",
     ...
     "yearbook", [{"vid": "00001", "seq": 44}, {"vid": "00001", "seq": 14}], []),
    ...
    (1947, "Rabbi Sanders A. Tofield arrives",
     ...
     "both", [{"vid": "00086", "seq": 10}], ["isjl", "nps"]),
    ...
    (1952, "National recognition for youth work",
     ...
     "yearbook", [{"vid": "00087", "seq": 9}, {"vid": "00087", "seq": 52}], []),
    ...
    (1957, "A day school takes root",
     "The Foundation School (attested from 1957) grows into the Solomon Schechter Day School — by 1965-66 a full graded school, 1st through 5th grade, alongside kindergarten, Hebrew School, and Sunday School.",
     "yearbook", [{"vid": "00024", "seq": 98}], []),
    (1961, "First Bat Mitzvah ceremonies",
     "Under Rabbi Tofield's leadership the Center pioneers Bat Mitzvah in Jacksonville; by 1963-64 the yearbook's lifecycle section is headed 'Bar and Bas Mitzvahs.' The 2007-08 yearbook cover essay traces the whole arc: 'In my grandmother's day, women wore lace scarves in shul… Now, the properly dressed Bat Mitzvah wears a kippah and talit and even wraps tefillin.'",
     "both", [{"vid": "00022", "seq": 9}, {"vid": "00066", "seq": 5}], ["nps"]),
    ...
    (1980, "Rabbi Dov Kentof arrives",
     "For the next twenty years he leads education and youth; the 1999-2000 yearbook is dedicated to him, with a cover portrait painted by congregant artist Blanche Slott.",
     "yearbook", [{"vid": "00058", "seq": 3}], []),
    ...
    (2001, "Centennial",
     "The 2001-02 yearbook celebrates 100 years: 'Jacksonville Jewish Center Centennial Celebration 1901-2001.'",
     "yearbook", [{"vid": "00060", "seq": 1}], []),
    ...
    (2011, "Fire in Springfield; a family reunited",
     "Fire damages the long-vacant original building at Third & Silver (later demolished). The same year, Beth Shalom Congregation re-merges with the Center.",
     "research", [], ["wikipedia", "isjl"]),
...
STORIES = [
    ...
    },
    {
        ...
        "body": [
            ...
            "The cover essay traces the arc: a first synagogue with 'a gallery reserved for women'; mixed seating with the move to Third & Silver and the Conservative movement; women entering corporate leadership in the 1950s; Bat Mitzvah accepted alongside Bar Mitzvah (Jacksonville's first, under Rabbi Tofield); women called to the Torah by century's end.",
...
MYSTERIES = [
    {
        ...
        "citations": [{"vid": "00077", "seq": 24}, {"vid": "00058", "seq": 51}, {"vid": "00012", "seq": 9}, {"vid": "00034", "seq": 50}],
    },
    {
        "id": "moss-moscovitz",
    ...
    },
    {
        ...
        "status": "open",
        "body": "Wikipedia dates B'nai Israel's first synagogue at Jefferson & Duval to 1907; the ISJL encyclopedia says the congregation 'constructed a synagogue… by 1909.' Outside sources disagree; the yearbooks (which begin in 1926) cannot adjudicate.",
        "citations": [],
    },
    {
        "id": "annex-date",
